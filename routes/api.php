...
$api->version('v1', function ($api) {
    ...
    $api->post('/take_order/protest_service_price','App\Http\Controllers\Api\User\TakeOrderController@protestServicePrice');
    ...
    $api->post('/send_order/protest_carriage','App\Http\Controllers\Api\User\SendOrderController@protestCarriage');
